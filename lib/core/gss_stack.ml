...
(* let update_all_stacks_with_actions g new_stacks next_actions = *)
(*   let updated_stacks = List.map2 update_stack_with_actions new_stacks next_actions in *)
(*   { g with stacks = updated_stacks } *)
(* ;; *)
...
(* let apply_actions_to_all_stacks g updated_stacks next_actions = *)
(*   let final_stacks = *)
(*     List.map2 (apply_all_actions_to_stack g) updated_stacks next_actions *)
(*   in *)
(*   { g with stacks = final_stacks } *)
(* ;; *)
